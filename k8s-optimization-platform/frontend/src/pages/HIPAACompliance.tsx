    ...
    <Box p={3} sx={{ bgcolor: '#0f1724', minHeight: '100vh', color: '#e8eaf0' }}>
      ...
      <Grid container spacing={2} sx={{ mb: 3, mt: 2 }}>
        {[
          ...
          { label: 'PHI Protected', value: data.phi_protected ? 'Yes' : 'No', color: data.phi_protected ? '#4ade80' : '#f87171' },
          { label: 'Last Risk Assessment', value: new Date(data.last_risk_assessment).toLocaleDateString(), color: '#e8eaf0' },
        ].map((k) => (
            ...
            <Table size="small">
              ...
              <TableBody>
                {(data.safeguards || []).map((s) => (
                  <TableRow key={s.safeguard} hover sx={{ '&:hover': { bgcolor: '#232d3f' } }}>
                    <TableCell sx={{ color: '#e8eaf0', fontWeight: 600, fontSize: 13, borderColor: '#2a3245' }}>{s.safeguard}</TableCell>
                  ...
                  {failedDetail.map((c) => {
                    ...
                    return (
                      <TableRow key={c.control_id} hover sx={{ '&:hover': { bgcolor: '#232d3f' } }}>
                        ...
                        <TableCell sx={{ color: '#8892a4', fontSize: 11, borderColor: '#2a3245', whiteSpace: 'nowrap' }}>{c.safeguard}</TableCell>
                        <TableCell sx={{ borderColor: '#2a3245' }}>
