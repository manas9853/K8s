    ...
    <Box p={3} sx={{ bgcolor: '#0f1724', minHeight: '100vh', color: '#e8eaf0' }}>
      ...
      <Grid container spacing={2} sx={{ mb: 3, mt: 2 }}>
        {[
          ...
          { label: 'Status', value: data.compliance_status, color: data.compliance_status === 'Compliant' ? '#4ade80' : '#f87171' },
          ...
          { label: 'Next Assessment', value: new Date(data.next_assessment).toLocaleDateString(), color: '#f59e0b' },
        ].map((k) => (
            ...
            <Table size="small">
              ...
              <TableBody>
                {(data.requirements || []).map((r) => (
                  <TableRow key={r.req} hover sx={{ '&:hover': { bgcolor: '#232d3f' } }}>
                    <TableCell sx={{ color: '#e8eaf0', fontWeight: 600, fontSize: 13, borderColor: '#2a3245' }}>{r.req}</TableCell>
