    ...
    <Box p={3} sx={{ bgcolor: '#0f1724', minHeight: '100vh', color: '#e8eaf0' }}>
      ...
      <Grid container spacing={2} sx={{ mb: 3, mt: 2 }}>
        {[
          ...
          { label: 'Status', value: data.certification_status, color: data.certification_status === 'Certified' ? '#4ade80' : '#f59e0b' },
          ...
          { label: 'Certification Date', value: new Date(data.certification_date).toLocaleDateString(), color: '#e8eaf0' },
        ...
        <CardContent>
          ...
          <TableContainer>
            <Table size="small">
              ...
              <TableBody>
                {(data.domains || []).map((d) => (
                  <TableRow key={d.domain} hover sx={{ '&:hover': { bgcolor: '#232d3f' } }}>
                    <TableCell sx={{ color: '#e8eaf0', fontWeight: 600, fontSize: 13, borderColor: '#2a3245' }}>{d.domain}</TableCell>
                    <TableCell align="right" sx={{ color: '#8892a4', fontSize: 13, borderColor: '#2a3245' }}>{d.controls}</TableCell>
                    <TableCell align="right" sx={{ color: '#4ade80', fontWeight: 600, fontSize: 13, borderColor: '#2a3245' }}>{d.passed}</TableCell>
                    <TableCell align="right" sx={{ color: d.failed > 0 ? '#f87171' : '#8892a4', fontWeight: 600, fontSize: 13, borderColor: '#2a3245' }}>{d.failed}</TableCell>
                    <TableCell sx={{ borderColor: '#2a3245' }}>
                      <Box display="flex" alignItems="center" gap={1}>
                        <LinearProgress
                          variant="determinate"
                          value={d.score}
                          sx={{ flex: 1, height: 6, borderRadius: 3, bgcolor: '#2a3245', '& .MuiLinearProgress-bar': { bgcolor: scoreColor(d.score) } }}
                        />
                  ...
                  {failedDetail.map((c) => {
                    ...
                    return (
                      <TableRow key={c.control_id} hover sx={{ '&:hover': { bgcolor: '#232d3f' } }}>
                        ...
                        <TableCell sx={{ color: '#8892a4', fontSize: 11, borderColor: '#2a3245', whiteSpace: 'nowrap' }}>{c.domain}</TableCell>
                        <TableCell sx={{ borderColor: '#2a3245' }}>
